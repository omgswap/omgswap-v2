      ...
      <PaddedColumn>
        <AutoColumn gap="14px">
          ...
          <Text style={{ marginBottom: '8px', textAlign: 'center' }}>
            OMGSwap now supports token lists. You can add your own custom lists via IPFS, HTTPS and ENS.{' '}
          </Text>
          ...
          <OutlineCard style={{ marginBottom: '8px', padding: '1rem' }}>
            <Text fontWeight={400} fontSize={14} style={{ textAlign: 'center' }}>
              Token lists are an{' '}
              <ExternalLink href="https://github.com/omgswap/token-lists">open specification</ExternalLink>. Check out{' '}
